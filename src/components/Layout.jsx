  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg  navbar-dark bg-dark">
        <a className="navbar-brand" href="/">Todo Demo</a>
            ...
            {authenticated ? (
              <div className="dropdown">
                ...
                <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a className="dropdown-item" href={getLogoutURL()}>Logout</a>
                </div>
              </div>
            ) : (
              <span className="navbar-text">
                <a className="btn btn-inline-primary" role="button" href={getLoginURL()}>Login</a>
              </span>
            )}
        </div>
      </nav>
